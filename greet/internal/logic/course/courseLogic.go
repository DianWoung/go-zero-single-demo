...
func NewCourseLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CourseLogic {
	return &CourseLogic{
...
func (l *CourseLogic) TestJwtToken(req *types.PageReq) (resp *types.Response, err error) {
